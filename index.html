          ...
          <li><a class="drop" href="#">Apuntes</a>
            <ul>
              <li><a class="drop" href="#">Parcial 1</a>
                <ul>
                  <li><a href="pages/lista_cotejo.html">Sistemas de informacion</a></li>
                  <li><a href="pages/Apunte2.html">Evolucion de los sistemas de informacion</a></li>
                  <li><a href="pages/Apunte3.html">Cliente Servidor</a></li>
                  <li><a href="pages/Apunte4.html">Sistemas de Computadoras Centrales y Dedicadas</a></li>
                  <li><a href="pages/Arquitectura cliente-servidor.html">Arquitecuta cliente servidor</a></li>
                  <li><a href="pages/protocolos de comunicacion en redes.html">Protocolos de comunicacion en redes</a></li>
                  <li><a href="pages/clasificar los sistemas de informacion.html">CLasificacion de los sistemas de informacion de acuerdo a su arquitectura</a></li>
                  <li><a href="pages/p">Procesos de diagramacion de componentes de la arquitecura Cliente-Servidor</a></li>
                 </ul>
              </li>
